...
if("TRUE" STREQUAL "TRUE")
  set(barc_SOURCE_PREFIX /home/odroid/barc/workspace/src/barc)
  set(barc_DEVEL_PREFIX /home/odroid/barc/workspace/devel)
  set(barc_INSTALL_PREFIX "")
  set(barc_PREFIX ${barc_DEVEL_PREFIX})
else()
  set(barc_SOURCE_PREFIX "")
  set(barc_DEVEL_PREFIX "")
  set(barc_INSTALL_PREFIX /home/odroid/barc/workspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'barc' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'BARC team <jon.gonzales@berkeley.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'barc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/barc/workspace/src/barc/${idir}'.  Ask the maintainer 'BARC team <jon.gonzales@berkeley.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND barc_EXPORTED_TARGETS ${${barc_dep}_EXPORTED_TARGETS})
endforeach()
