...
class RecordExperiment():
	...
	self.topics = ['/imu/data', '/encoder', '/ecu', '/ecu_pwm', '/image_transformed/compressed/', '/fix', '/state', '/ultrasound']
    ...
    def upload_message(self, topic, msgs, tss):
        vars_list = ['roll', 'pitch', 'yaw',
                     ...
                     'car_vel', 'us_dist', 'us_rate','us_accl','obj_psi',
                     'ultrasound_front','ultrasound_right']
        ...
        for msg in msgs:
            ...
            ################ STATE FOR OUR GROUP
            if topic == '/state':
                car_vel = msg.car_vel#msg.angular_velocity.x
                us_dist = msg.us_dist#msg.angular_velocity.y
                us_rate = msg.us_rate#msg.angular_velocity.z
                us_accl = msg.us_accl#msg.linear_acceleration.x
                obj_psi = msg.obj_psi#msg.linear_acceleration.
